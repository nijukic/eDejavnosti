                <nav class="navbar navigacija sticky-top">
                    ...
                    <img class="logotip" src=/igniter/assets/img/logo_transparen.png>
                ...
                <div id="mySidenav" class="sidenav">
                    ...
                    <?php echo "<a href=". site_url() . "/prijava/uporabniki" . ">"?><i class="fas fa-angle-right"></i> <?php echo "Uvoz/Izvoz Uporabnikov</a>" ?>
                    <br>
